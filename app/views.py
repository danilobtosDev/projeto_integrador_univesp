...
def set_location():
    ...
    if data.get('region'):
        # Localização manual (prioritária)
        region = data['region']
        ...
        # Localização automática (PJI240: Geocodificação Reversa)
        
        # *** AQUI ENTRA A LÓGICA DE GEOCDIFICAÇÃO REVERSA DO PJI240 ***
        # Por enquanto, usa-se coordenadas como nome da região
